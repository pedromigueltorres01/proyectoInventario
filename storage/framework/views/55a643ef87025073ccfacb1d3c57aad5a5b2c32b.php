  ...
  <tbody>
    ...
    <tr class="table-secondary">
      ...
      <td  > <a href="<?php echo e(route('productos.edit',$producto->id)); ?>" style="color: black; text-decoration: none;"><?php echo e($producto->Marca); ?> </a></td>
      ...
      <td ><a href="<?php echo e(route('productos.edit',$producto->id)); ?>" style="color: black; text-decoration: none;"> <?php echo e($producto->Descripcion); ?></a></td>
      <td ><a href="<?php echo e(route('productos.edit',$producto->id)); ?>" style="color: black; text-decoration: none;"><?php echo e($producto->Stock_cantidad); ?></a></td>
      <td ><a href="<?php echo e(route('productos.edit',$producto->id)); ?>" style="color: black; text-decoration: none;"><?php echo e($producto->creatd_at); ?></a></td>
