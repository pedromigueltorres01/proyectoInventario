	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Buscar lista  <small>de Observaciones de un Miembro</small></h1>
			</div>
			<p class="lead">
		</div>
		...
		<div class="container-fluid" id="div">
			<form class="well" onsubmit="event.preventDefault();onFormSubmit();">
				<div class="row">
					...
					<div class="col-xs-12">
						<p class="text-center">
							<button type="submit" onclick="buscar_miembro();ocultar();" class="btn btn-primary btn-raised btn-sm"><i class="zmdi zmdi-search"></i> &nbsp; Buscar</button>
						</p>
					</div>
				</div>
			</form>
