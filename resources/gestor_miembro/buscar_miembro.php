...
<head>
 ...
 <link rel="stylesheet" href="../../css/Consulta_Disponibilidad.css">
  ...
  <script src="../../js/Redirecciones_Pestañas.js"></script>
    <script src="../../js/Validaciones_Escritura.js"></script>
...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Buscar un  <small>Miembro específico</small></h1>
			</div>
			<p class="lead">
		</div>
		...
		<div>
		<div class="container-fluid"  >
			<form class="well"  id="div"  onsubmit="event.preventDefault();onFormSubmit();">
				<div class="row">
					<div class="col-xs-12 col-md-8 col-md-offset-2">
						<div class="form-group label-floating">
							<span class="control-label">¿A quién estas buscando?</span>
							<input class="form-control" id="datosPersona" type="text" name="search_admin_init" >
						</div>
					</div>
					<div class="col-xs-12"> 
						<p class="text-center">
	...
	<script src="../../js/consultaMiembro.js"></script>
	<script>
		$.material.init();
	</script>
</body>
