		...
		<!--<div class="container-fluid">
			<form class="well" onsubmit="event.preventDefault();onFormSubmit();">
				<div class="row">
					...
					<div class="col-xs-12">
						<p class="text-center">
							<button title="Consulta general de usuarios" id="consultar" value="consultar" onclick="ajax_post();" type="submit" class="btn btn-primary btn-raised btn-sm"><i class="zmdi zmdi-search"></i> &nbsp; Buscar todos los usuarios</button>
