...
<html lang="es">
<head>
	<title>AGESTION DE USUARIO</title>
	<meta charset="UTF-8">
	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				BDV SG. MONITOR <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- MENU CONF. -->
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> GESTOR  <small> DE USUARIOS</small></h1>
			</div>
			<p class="lead">
		</div>
		...
		<div class="container-fluid">
			<ul class="breadcrumb breadcrumb-tabs">
			  	...
			  	<li>
			  		...
			  		<button type="submit" onclick="ajax_post();" id="consultar" value="consul_general" class="btn btn-success"><i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE USUARIOS</button>
			  	</li>
			  	<li>
